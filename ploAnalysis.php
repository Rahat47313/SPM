        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0"><a
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="ploAnalysis.php"><i
                    ...
                    <div class="card-header">
                        <ul class="nav nav-tabs card-header-tabs">
                            <li class="nav-item"><a class="nav-link"
                                    href="ploAnalysisDepartmentProgramSchoolAverage.php">School/Department/Program
                                    Average<br></a></li>
                            <li class="nav-item"><a class="nav-link" href="ploAnalysisOverall.php">Overall, CO wise,
                                    Course wise<br></a></li>
                        </ul>
                    </div>
                </div>
