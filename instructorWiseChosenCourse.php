                    ...
                    <div class="card-header">
                        <ul class="nav nav-tabs card-header-tabs">
                            ...
                            <li class="nav-item"><a class="nav-link active"
                                    href="instructorWiseChosenCourse.php">Instructor wise (Chosen Course)<br></a></li>
                    ...
                    <div class="card-body">
                        <form method="POST" style="margin: 50px;">
                            <div class="row" style="margin-bottom: 50px;">
                                <div class="col">
                                    <div
                                        class="d-flex d-xl-flex justify-content-center justify-content-sm-center justify-content-md-center justify-content-lg-end justify-content-xl-end">
                                        <div class="dropdown">
                                          <select name="courseCode" class="btn btn-primary dropdown-toggle"
                                                aria-expanded="false" data-bs-toggle="dropdown" type="button">
                                            <div class="dropdown-menu">
                                              <option disabled selected class="dropdown-item disabled">Course Code</a>
                                              <option value="EEE131" class="dropdown-item">EEE131</option>
                                              <option value="EEE231" class="dropdown-item">EEE231</option>
                                              <option value="EEE233" class="dropdown-item">EEE233</option>
                                              <option value="ENG101" class="dropdown-item">ENG101</option>
                                              <option value="CSC101" class="dropdown-item">CSC101</option>
                                              <option value="MKT101" class="dropdown-item">MKT101</option>
                                            </div>
                                          </select>
                                        </div>
                                    </div>
                                ...
                                <div class="col me-2">
                                    <div
                                        class="text-dark d-flex d-xl-flex justify-content-center justify-content-sm-center justify-content-md-center justify-content-lg-center justify-content-xl-center justify-content-xxl-center fw-bold h5 mb-0">
                                        <div class="dropdown d-flex d-print-flex float-end d-sm-flex float-sm-end d-md-flex float-md-end d-lg-flex float-lg-end d-xl-flex float-xl-end d-xxl-flex float-xxl-end justify-content-xl-center"
                                            id="dropdownUserType-3">
                                ...
                                <div class="col">
                                    <div
                                        class="d-flex d-sm-flex d-md-flex d-lg-flex d-xl-flex justify-content-center justify-content-sm-center justify-content-md-center justify-content-lg-start justify-content-xl-start justify-content-xxl-start">
                                        <button class="btn btn-primary" type="submit" name="submitCourseCode" value="Submit">Submit</button></div>
                                </div>
                            </div>
                        </form>
                        ...
                        <div class="row" style="margin-bottom: 50px;">
                            <div class="col">
                                <div
                                    ...
                                    <button onclick="viewInstructorWiseChosenCourse()" class="btn btn-primary" type="button">View</button></div>
                            </div>
                        </div>
                        <div
                            class="row d-flex d-lg-flex d-xl-flex justify-content-center justify-content-lg-center justify-content-xl-center">
