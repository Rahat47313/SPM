    ...
    <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
      <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
        ...
        <ul class="navbar-nav text-light" id="accordionSidebar">
          ...
          <li class="nav-item"><a class="nav-link active" href="dataEntry.php"><i class="fa fa-edit"></i><span>Data Entry</span></a></li>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <div class="d-sm-flex justify-content-between align-items-center mb-4">
            <h3 class="text-dark mb-0">Data Entry</h3>
          </div>
          <hr>
          ...
          <div class="row justify-content-evenly">
            <div class="col-md-6 col-xl-3 mb-4">
              <div class="card shadow border-start-primary py-2">
                <div class="card-body">
                  <a href="exam.php" class="stretched-link"></a>
                  <div class="row align-items-center no-gutters">
                    <div class="col me-2">
                      <div class="text-dark fw-bold h5 mb-0"><span style="color: #4e73df;">Exam</span></div>
                    </div>
          ...
          <div class="row justify-content-evenly">
            <div class="col-md-6 col-xl-3 mb-4">
              <div class="card shadow border-start-primary py-2">
                <div class="card-body">
                  <a href="inputBacklogData.php" class="stretched-link"></a>
                  <div class="row align-items-center no-gutters">
                    <div class="col me-2">
                      <div class="text-dark fw-bold h5 mb-0"><span style="color: #4e73df;">Input
                          Backlog Data</span></div>
                    </div>
                    <div class="col-auto"><i class="far fa-file-archive fa-2x text-gray-300"></i>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="row justify-content-evenly">
            <div class="col-md-6 col-xl-3 mb-4">
              <div class="card shadow border-start-success py-2">
                <div class="card-body">
                  <a href="createCourseOutline.php" class="stretched-link"></a>
                  <div class="row align-items-center no-gutters">
                    <div class="col me-2">
                      <div class="text-dark fw-bold h5 mb-0"><span style="color: rgb(28,200,138);">Create Course Outline</span></div>
                    </div>
          ...
          <div class="row justify-content-evenly">
            <div class="col-md-6 col-xl-3 mb-4">
              <div class="card shadow border-start-info py-2">
                <div class="card-body">
                  <a href="viewCourseOutline.php" class="stretched-link"></a>
                  <div class="row align-items-center no-gutters">
                    <div class="col me-2">
                      <div class="row g-0 align-items-center">
                        <div class="col-auto">
                          <div class="text-dark fw-bold h5 mb-0 me-3"><span style="color: rgb(54,185,204);">View Course Outline</span>
                          </div>
                        </div>
                      </div>
                    </div>
