        ...
        <div class="card">
          <div class="card-header">
            <ul class="nav nav-tabs card-header-tabs">
              <li class="nav-item"><a class="nav-link" href="ploAnalysisDepartmentProgramSchoolAverage.php" target="_self">School/Department/Program
                  Average<br></a></li>
              <li class="nav-item"><a class="nav-link active" href="ploAnalysisOverall.php" target="_self">Overall, CO
                  wise, Course wise<br></a></li>
            </ul>
          </div>
            ...
            <div class="row" style="margin-bottom: 50px;margin-right: 0px;margin-left: 0px;">
              <div class="col">
                <div class="d-flex d-sm-flex d-md-flex d-lg-flex d-xl-flex d-xxl-flex justify-content-center justify-content-sm-center justify-content-md-end justify-content-lg-end justify-content-xl-end justify-content-xxl-end">
                  <button onclick="overallPlo()" class="btn btn-primary" type="button">Overall</button>
                </div>
              </div>
              <div class="col">
                <div class="d-flex d-xl-flex d-xxl-flex justify-content-center justify-content-xl-center justify-content-xxl-center">
                  <button onclick="coWisePlo()" class="btn btn-primary" type="button">CO wise</button>
                </div>
              </div>
              <div class="col">
                <div class="d-flex justify-content-center justify-content-sm-center justify-content-md-start justify-content-lg-start justify-content-xl-start justify-content-xxl-start">
                  <button onclick="courseWisePlo()" class="btn btn-primary" type="button">Course wise</button>
                </div>
              </div>
            </div>
              ...
              <div class="col-lg-7 col-xl-8">
                <div class="card shadow mb-4">
                  <div class="card-header d-flex justify-content-between align-items-center">
                    <h6 class="text-primary fw-bold m-0">Overall PLO Analysis</h6>
                  </div>
