...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 25, 2023 at 10:08 AM
...
--
-- Table structure for table `backlog_data_t`
--

CREATE TABLE `backlog_data_t` (
  `backlogdataID` int(11) NOT NULL,
  `studentID` int(11) NOT NULL,
  `year` year(4) NOT NULL,
  `semester` varchar(6) NOT NULL,
  `courseID` varchar(6) NOT NULL,
  `sectionNum` int(11) NOT NULL,
  `obtainedGrade` varchar(2) NOT NULL,
...
--
-- Indexes for table `backlog_data_t`
--
ALTER TABLE `backlog_data_t`
  ADD PRIMARY KEY (`backlogdataID`);
...
--
-- AUTO_INCREMENT for table `backlog_data_t`
--
ALTER TABLE `backlog_data_t`
  MODIFY `backlogdataID` int(11) NOT NULL AUTO_INCREMENT;
