            ...
            <div class="container-fluid d-flex flex-column p-0"><a
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link" href="dataEntry.php"><i class="fa fa-edit"></i><span>Data
                                Entry</span></a></li>
                    <li class="nav-item"><a class="nav-link active" href="viewCourseOutline.php"><i
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Course Outline</h3>
                    </div>
                    <hr>
                                ...
                                <div class="card shadow border-start-success py-2">
                                    <div class="card-body">
                                        <div class="row align-items-center no-gutters">
                                            <div class="col me-2">
                                                <div
                                                    class="text-dark d-flex d-sm-flex d-md-flex d-lg-flex d-xl-flex justify-content-center justify-content-sm-center justify-content-md-center justify-content-lg-center justify-content-xl-center fw-bold h5 mb-0">
                                ...
                                <div class="card shadow border-start-warning py-2">
                                    <div class="card-body">
                                        <div class="row align-items-center no-gutters">
                                            <div class="col me-2">
                                                <div
                                                    class="text-dark d-flex d-lg-flex d-xl-flex justify-content-center justify-content-lg-center justify-content-xl-center fw-bold h5 mb-0">
                                                    <div class="dropdown d-flex d-print-flex float-end d-sm-flex float-sm-end d-md-flex float-md-end d-lg-flex float-lg-end d-xl-flex float-xl-end d-xxl-flex float-xxl-end justify-content-xl-center"
                                                        id="dropdownUserType-2">
                        ...
                        <div class="row" style="margin-bottom: 50px;">
                            <div class="col">
                                <div
                                    ...
                                    <button class="btn btn-primary" type="submit" value="Submit" name="submit">SUBMIT</button></div>
                            </div>
                        </div>
                    </form>
                </div>
